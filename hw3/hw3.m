...
% Training 
fprintf('Training ... ');
VLFEAT_FOLDER = './vlfeat-0.9.17'; %Put here the path to the root floder of VlFeat
addpath([VLFEAT_FOLDER  '/toolbox']);
vl_setup;

tic;
% TODO: Put here the SVM training code here
lambda = 100;
[w b] = vl_svmtrain(DataTrain',LabelsTrain',lambda, 'verbose');
